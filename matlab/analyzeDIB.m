...
% (3,0), with 100 points. This structure contains a variety of gamma values
% used and DIB outputs. This loads the variable "highpStruct"
load('highpData.mat');

% Folder where we will save images
folder = '../../images/clustering/same_beta/';
...
for i = 1:size(highpStruct,2)
    ...
    fig = figure;
    hold on
    % Show the contour plot of the DIB distribution, where we only show the
    % levels associated with the clusters (to avoid interpolation and extra
    % lines). Colour each region in by using contourf instead of contour.
